...
import { Search, Eye, Download, Truck, ArrowRight } from 'lucide-react';
...
const isInteractiveTarget = (target) => target.closest('button, a, select, input, label');
...
export default function OrdersIndex({ orders = { data: [], links: [], meta: { last_page: 1 } }, filters = {}, statuses = [], sources = [], couriers = [], paymentStatuses = [] }) {
    ...
    return (
        <AdminLayout title="Orders">
            ...
            <form onSubmit={search} className="flex flex-wrap gap-2 mb-6">
                ...
                <Select name="payment_status" defaultValue={filters.payment_status || ''} placeholder="All payments"
                    options={[
                ...
                <CardBody className="p-0 overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                                    ...
                                    <td className="px-6 py-4">
                                        {order.default_next_label ? (
                                            <button
                                                ...
                                                title={`Mark as ${order.default_next_label}`}
                                            >
                                                {order.default_next_label}
                                                <ArrowRight size={12} />
                                            </button>
                            ...
                            {!rows.length && (
                                <tr><td colSpan={10} className="px-6 py-16 text-center text-slate-400">No orders yet.</td></tr>
                            )}
                        </tbody>
                    </table>
                </CardBody>
